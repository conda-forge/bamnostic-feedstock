About bamnostic-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bamnostic-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3668&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bamnostic-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bamnostic` can be installed with `conda`:
...
```
mamba install bamnostic
```

It is possible to list all of the versions of `bamnostic` available on your platform with `conda`:
...
```
mamba search bamnostic --channel conda-forge
```
...
mamba repoquery search bamnostic --channel conda-forge

# List packages depending on `bamnostic`:
mamba repoquery whoneeds bamnostic --channel conda-forge

# List dependencies of `bamnostic`:
mamba repoquery depends bamnostic --channel conda-forge
```
